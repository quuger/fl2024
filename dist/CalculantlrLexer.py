...
def serializedATN():
    return [
        ...
        0,8,1,1,3,2,5,3,7,4,9,5,11,6,13,7,15,8,1,0,2,1,0,48,57,2,0,9,9,32,
        ...
        0,0,15,35,1,0,0,0,17,18,5,42,0,0,18,2,1,0,0,0,19,20,5,47,0,0,20,
        ...
        33,14,1,0,0,0,34,36,7,1,0,0,35,34,1,0,0,0,36,37,1,0,0,0,37,35,1,
        0,0,0,37,38,1,0,0,0,38,39,1,0,0,0,39,40,6,7,0,0,40,16,1,0,0,0,3,
        0,32,37,1,6,0,0
    ]

class CalculantlrLexer(Lexer):
